...
WEAPON_YOLO_MODEL_PATH = os.path.join(PROJECT_ROOT, "models", "yolo", "best.pt") # << PLACEHOLDER
...
WEAPON_CLASS_ID = 1 # Assuming the weapon model uses class 1 for weapons (NEW)
